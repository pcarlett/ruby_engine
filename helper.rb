...
class Helper
   ...
   def printHelp
      ...
      puts ""
      puts "-l xxx -m zzz -e kkk -x yyy: test locally"
      puts "-lb xxx -m zzz -e kkk -x yyy: test dfp locally with a single protected object"
      puts "-t xxx -m zzz -e kkk -x yyy: peforms a static test without execute it on the simulator"
      puts "-tb xxx -m zzz -e kkk -x yyy: test environment with block."
